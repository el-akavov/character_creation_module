...
def attack(char_name: str, char_class: str) -> str:
    """Функция нанесения урона атаки в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция блокировки урона атаки в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция нанесения урона от умения в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функционал тренировки атаки, защиты и умения."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    """Запуск модуля с вводом имени персонажа."""
    run_screensaver()
